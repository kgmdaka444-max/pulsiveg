...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-black/40 flex items-center justify-center press hover:scale-105 transition-transform duration-300"
